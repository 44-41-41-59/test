...
router.route('/review').get(getReviews).post(bearer('registered'), permissions('addReview'), addReview);
...
router.route('/review/:id').get(getOneReview).put(bearer('registered'), permissions('updateReview'), editReview).delete(bearer('registered'), permissions('deleteReview'), deleteReview);
